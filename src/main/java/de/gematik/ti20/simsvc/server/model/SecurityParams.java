...
public class SecurityParams {
  ...
  @Schema(description = "Keystore encoded in Base64", required = true)
  private final String storeContent;

  @Schema(description = "Password for the keystore", required = true)
  private final String storePass;

  @Schema(description = "Alias for the keystore", required = true)
  private final String keyAlias;

  @Schema(description = "Password for the key", required = true)
