...
/**
 * Encodes JWKs used to verify PoPP tokens issued by this service.
 */
public class SignedJwksToken {

  @Getter
  public static class Header {
    private String typ = "jwk-set+jwt";
    private String kid;
  ...
  public static class Claims {
    ...
    public Claims(final String iss, final JsonWebKeySet publicJwk) {
      this.iss = iss;
  ...
  public SignedJwksToken(final Header header, final Claims claims) {
    this.header = header;
    this.claims = claims;
  }
