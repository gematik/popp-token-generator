...
public class TokenParams {
  ...
  @Schema(
      description = "Method of proof",
      example = "ehc-provider-user-x509",
      required = false,
      defaultValue = "ehc-provider-user-x509")
  private final String proofMethod;

  @Schema(description = "Patient proof time", example = "1700000000", required = false)
  private final Long patientProofTime;

  @Schema(description = "Issued at time", example = "1700000000", required = false)
  private final Long iat;

  @Schema(description = "Patient ID", example = "X123456789", required = true)
  private final String patientId;

  @Schema(description = "Insurer ID", example = "Y123456789", required = true)
  private final String insurerId;

  @Schema(description = "Actor ID", example = "Z123456789", required = true)
  private final String actorId;

  @Schema(description = "Actor Profession OID", example = "1.2.276.0.76.4.32", required = true)
