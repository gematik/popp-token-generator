...
class JwkConfigurationTest {
  ...
  void thatAValidJwkSetIsReturned() {
    ...
    final JsonWebKeySet actual = jwkConfiguration.jwkSource(keyStore);
    assertThat(actual.getJsonWebKeys()).hasSize(1);
    assertThat(actual.getJsonWebKeys().getFirst().getKeyId())
        .isEqualTo("rFTrXFE1si4oH7N8d8vHCTb6XxzHLRukYbA2zgXKvog");
  }
}
